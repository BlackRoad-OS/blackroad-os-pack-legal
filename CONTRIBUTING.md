# Contributing to blackroad-os-pack-legal
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad-os-pack-legal.git
cd blackroad-os-pack-legal

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad-os-pack-legal.git
